...
<div class="row">
    <div class="col-md-8">
        ...
        <?php echo $this->Form->create('Paciente'); ?>
                            <h4>Faça login para acessar os serviços.</h4>
                <hr />
                <div class="form-group">
                    <div class="col-md-10">
                        ...
                        <span class="field-validation-valid text-danger" data-valmsg-for="data[Paciente][login]" data-valmsg-replace="true"></span>
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-md-10">
                        ...
                        <span class="field-validation-valid text-danger" data-valmsg-for="data[Paciente][senha]" data-valmsg-replace="true"></span>
                    </div>
                </div>
                <div class="form-group">
